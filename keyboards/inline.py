        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="Менеджер", callback_data="role_менеджер"
                )
            ],
            [InlineKeyboardButton(text="Селлер", callback_data="role_селлер")],
            [
                InlineKeyboardButton(
                    text="Эксперт", callback_data="role_эксперт"
                )
            ],
        ]
    )
...
def confirm_keyboard():
    confirm_buttons = InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="🔁 Отмена", callback_data="confirm_restart"
                )
            ],
        ]
    )
    ...
    admin_buttons = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="✅ Разместить",
                    callback_data=f"moderate_accept_{user_id}",
                ),
                InlineKeyboardButton(
                    text="❌ Отказать",
                    callback_data=f"moderate_reject_{user_id}",
                ),
            ]
        ]
    )
...
def channel_post_keyboard(username: str) -> InlineKeyboardMarkup:
    channal_button = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="💬 Написать",
                ...
                InlineKeyboardButton(
                    text="📥 Разместиться",
                    url="https://t.me/seller_manager163_bot?start=add",
                ),
            ]
        ]
    )
...
def contact_keyboard() -> InlineKeyboardMarkup:
    contact = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="✅ Мой Telegram username",
                    callback_data="contact_self",
                )
            ],
            [
                InlineKeyboardButton(
                    text="✏ Указать другой контакт",
                    callback_data="contact_custom",
                )
            ],
        ]
    )
...
def post_type_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="📣 Вакансия", callback_data="vacancy"
                )
            ],
        ]
    )
...
def cancel_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="❌ Отменить", callback_data="confirm_restart"
                )
            ]
        ]
    )
...
def confirm_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="✅ Отправить", callback_data="confirm_ok"
                ),
                InlineKeyboardButton(
                    text="❌ Отменить", callback_data="confirm_restart"
                ),
...
def type_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="🧑‍💼 Резюме", callback_data="type_resume"
                )
            ],
            [
                InlineKeyboardButton(
                    text="🏢 Вакансия", callback_data="type_vacancy"
                )
            ],
        ]
    )
...
def contact_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="📌 Свой username", callback_data="contact_self"
                )
            ],
            [
                InlineKeyboardButton(
                    text="✍️ Ввести вручную", callback_data="contact_custom"
                )
            ],
        ]
    )
...
def finish_kb():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="✅ Завершить", callback_data="finish_post"
                )
            ],
        ]
    )
...
def confirm_keyboard():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    text="✅ Всё верно", callback_data="confirm_ok"
                ),
                InlineKeyboardButton(
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [
                ...
                InlineKeyboardButton(
                    text="✖️ Отклонить", callback_data=f"reject_{user_id}"
                ),
            ]
        ]
    )
